...
class StaticTransformPublisher(Node):
    def __init__(self):
        ...
        self.ultrasonic_front_pub = self.create_publisher(Range, '/ultrasound/front', 10)
        self.ultrasonic_left_pub = self.create_publisher(Range, '/ultrasound/left', 10)
        self.ultrasonic_right_pub = self.create_publisher(Range, '/ultrasound/right', 10)
