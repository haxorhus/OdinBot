...
class MotorControlNode2(Node):
    def __init__(self):
        super().__init__('control_motor_derecho')
        self.publisher_motor_l = self.create_publisher(Int32,'/cmd_vel_r',10)
        self.get_logger().info('Nodo control de motor derecho iniciado')
